...
import com.chenhai.exception.AccountLockedException;
import com.chenhai.exception.AccountNotFoundException;
import com.chenhai.exception.PasswordErrorException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee login(EmployeeLoginDTO employeeLoginDTO) {
        ...
        //密码比对
        // 对前端传输过来的明文密码进行加密处理 springboot框架默认整合了md5加密的功能
