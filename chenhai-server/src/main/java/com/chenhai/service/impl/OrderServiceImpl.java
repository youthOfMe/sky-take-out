...
import com.chenhai.entity.*;
import com.chenhai.exception.AddressBookBusinessException;
import com.chenhai.exception.OrderBusinessException;
import com.chenhai.exception.ShoppingCartBusinessException;
import com.chenhai.mapper.*;
import com.chenhai.result.PageResult;
import com.chenhai.service.OrderService;
import com.chenhai.utils.WeChatPayUtil;
...
import com.chenhai.websocket.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        orders.setTablewareNumber(orders.getTablewareNumber());
        orders.setTablewareStatus(orders.getTablewareStatus());
     ...
     * @param id
     */
    public void repet1ition(Long id) {
        // 查询当前用户id
        Long userId = BaseContext.getCurrentId();
