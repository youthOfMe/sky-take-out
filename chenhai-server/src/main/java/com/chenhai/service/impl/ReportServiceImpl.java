...
import com.chenhai.dto.GoodsSalesDTO;
import com.chenhai.entity.Orders;
import com.chenhai.mapper.OrderMapper;
import com.chenhai.mapper.UserMapper;
import com.chenhai.service.ReportService;
import com.chenhai.service.WorkspaceService;
import com.chenhai.vo.*;
...
public class ReportServiceImpl implements ReportService {
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        // 存放每天的新增用户数量 select count(id) from user where crete_time < ? and create_time > ?
    ...
    public OrderReportVO getOrderStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            Integer validOrderCount = getOrderCount(beginDateTime, endDateTime, 5);
     ...
     */
    @Override
    public void exportBasinessData(HttpServletResponse response) {
